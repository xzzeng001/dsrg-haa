...
def mbe_fci_corr(mf,e_tot,base_e_corr,ind_homo,ncas,nelec,caslst,vir_index,frozen_lst,mo_coeff,norder):
...
#            mycas1.max_cycle = 500
            mycas1.frozen=frozen_lst
            orb_indice1=[i for i in new_cas]
            mo1 = mycas1.sort_mo(orb_indice1, mo_coeff=mo_coeff, base=0)
            e_tot1=mycas1.kernel(mo1)[0]
            one_e_tot[ii]=e_tot1
            one_e_corr[ii]=e_tot1-e_tot
            with open('one-body.txt','a') as f:
        ...
        for ii,kk in enumerate(vir_index):
            ...
            for jj,ll in enumerate(vir_index):
                if ll > kk:
                    ...
                    orb_indice1=new_cas
#                    orb_indice1=[i+1 for i in new_cas]
                    mo1 = mycas2.sort_mo(orb_indice1,mo_coeff=mo_coeff,base=0)
