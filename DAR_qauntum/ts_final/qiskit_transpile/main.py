...
import numpy as np
from circuit import add_one_qubit_gates, add_two_qubit_gates
from qiskit.providers.aer import QasmSimulator


network=[2,1]
num_qubits=sum(network)
num_params=6*network[0]+2*4*network[0]
...
circ,iparams = add_two_qubit_gates(circ,q_reg,network,params,iparams)
