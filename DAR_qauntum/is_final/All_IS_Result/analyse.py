...
from vqe import main_vqe

def calculate_energy(data,filename,num_an):
    ...
    for ii in range(nn):
        ...
        ## the VQE energy
        e_no_noise=main_vqe(num_an,params[ii])

        with open(filename,'a') as f:
            np.savetxt(f,[[ii+1,energy_without_rem,energy_with_rem,res_H,e_no_noise]],fmt='%d     %15.8f     %15.8f     %15.8f    %15.8f')
